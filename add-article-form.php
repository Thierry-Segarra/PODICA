...
if(isset($_POST['titre']) && isset($_POST['contenu']) && isset($_POST['description']) && isset($_POST['categorie']))
{
    ...
    echo $titre.'<br>'.$contenu.'<br>'.$categorie.'<br>'.$description;
    if($titre !== "" && $contenu !== "" && $description !== "" && $categorie !== "")
    {
        ...
        {   
            ...
            $requete = "INSERT INTO `article`(`categorie`,`titre`, `descriptif`,`contenu`) VALUES ('".$categorie."','".$titre."','".$description."','".$contenu."')"; // id auto-increase
